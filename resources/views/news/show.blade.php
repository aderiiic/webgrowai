...
@section('content')
                ...
                <div class="px-8 py-8 border-t border-slate-200 bg-gradient-to-r from-slate-50 to-blue-50">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="text-sm text-slate-500 font-medium">Dela:</span>

                            <!-- Facebook Share -->
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}"
                               target="_blank"
                               class="group p-2 bg-white border border-slate-300 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 shadow-sm hover:shadow-md"
                               data-lead-cta="news_share_facebook"
                               title="Dela på Facebook">
                                <svg class="w-4 h-4 text-slate-600 group-hover:text-blue-600 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://twitter.com/intent/tweet?text={{ urlencode($post->title) }}&url={{ urlencode(request()->url()) }}"
                               target="_blank"
                               class="group p-2 bg-white border border-slate-300 rounded-lg hover:border-sky-300 hover:bg-sky-50 transition-all duration-200 shadow-sm hover:shadow-md"
                               data-lead-cta="news_share_twitter"
                               title="Dela på Twitter">
                                <svg class="w-4 h-4 text-slate-600 group-hover:text-sky-600 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <button onclick="copyToClipboard('{{ request()->url() }}')"
                                    class="group p-2 bg-white border border-slate-300 rounded-lg hover:border-green-300 hover:bg-green-50 transition-all duration-200 shadow-sm hover:shadow-md"
                                    title="Kopiera länk">
                                <svg class="w-4 h-4 text-slate-600 group-hover:text-green-600 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="copyToast" class="fixed bottom-4 right-4 bg-green-600 text-white px-4 py-2 rounded-lg shadow-lg transform translate-y-full transition-transform duration-300 z-50">
