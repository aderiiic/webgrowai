    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200/50 p-6">
            <div class="flex items-start space-x-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-blue-900 mb-2">AI-genererad veckodigest</h3>
                    <p class="text-blue-800">Konfigurera hur din automatiska veckodigest ska genereras och skickas. AI:n kommer att samla dina senaste resultat och skapa en professionell sammanfattning.</p>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-8">
                ...
                <div class="p-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-200/50">
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            <label class="text-lg font-semibold text-gray-900">E-postmottagare</label>
                            <p class="text-sm text-emerald-700">Komma-separerade e-postadresser som ska ta emot veckodigen</p>
                        </div>
                    </div>
                    <textarea rows="3" wire:model.defer="weekly_recipients" class="w-full px-4 py-3 bg-white border border-emerald-300 rounded-xl text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 resize-none" placeholder="namn1@example.com, namn2@example.com"></textarea>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200/50">
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-purple-700">Hur ska din kommunikation låta?</p>
                            </div>
                        </div>
                        <input type="text" wire:model.defer="weekly_brand_voice" class="w-full px-4 py-3 bg-white border border-purple-300 rounded-xl text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200" placeholder="t.ex. professionell, hjälpsam, personlig">
                    ...
                    <div class="p-6 bg-gradient-to-r from-orange-50 to-red-50 rounded-xl border border-orange-200/50">
                        ...
                        <input type="text" wire:model.defer="weekly_audience" class="w-full px-4 py-3 bg-white border border-orange-300 rounded-xl text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200" placeholder="t.ex. SMB-beslutsfattare, marknadsansvariga">
                ...
                <div class="p-6 bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl border border-yellow-200/50">
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-yellow-700">Vad vill du uppnå med dina insatser?</p>
                        </div>
                    </div>
                    <input type="text" wire:model.defer="weekly_goal" class="w-full px-4 py-3 bg-white border border-yellow-300 rounded-xl text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all duration-200" placeholder="t.ex. öka kvalificerade leads, förbättra konvertering">
                    @error('weekly_goal')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div class="p-6 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl border border-teal-200/50">
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-teal-700">Viktiga termer för din bransch (separera med komma)</p>
                        </div>
                    </div>
                    <input type="text" wire:model.defer="weekly_keywords" class="w-full px-4 py-3 bg-white border border-teal-300 rounded-xl text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200" placeholder="t.ex. CRM, kundresa, automatisering, lead generation">
