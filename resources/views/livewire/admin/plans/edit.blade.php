        ...
        <div class="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                ...
                <div class="p-6">
                                ...
                                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
                                        <div class="lg:col-span-5 space-y-1">
                                            ...
                                            <div class="px-3 py-2 border border-gray-200 bg-white rounded-lg text-sm font-mono">{{ $key }}</div>
                                        </div>
                                        ...
                                        <div class="lg:col-span-3 space-y-1">
                                            ...
                                            <input
                                                ...
                                                wire:model.defer="features['{{ $key }}'].limit_value"
                                        ...
                                        <div class="lg:col-span-2 space-y-1">
                                            ...
                                            <label class="inline-flex items-center p-2 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                                <input type="checkbox"
                                                       ...
                                                       wire:model="features['{{ $key }}'].is_enabled"
                                        ...
                                        <div class="lg:col-span-2">
                                            <button wire:click="deleteFeature('{{ $key }}')"
                                                    class="w-full inline-flex justify-center items-center px-3 py-2 bg-red-100 hover:bg-red-200 text-red-700 text-sm font-medium rounded-lg transition-colors duration-200">
                    ...
                    <!-- Lägg till ny feature -->
                    <div class="mt-8 p-4 bg-white rounded-lg border border-gray-200">
                        <h4 class="text-sm font-semibold text-gray-900 mb-3">Lägg till ny feature</h4>
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
                            <div class="lg:col-span-5">
                                <label class="block text-xs font-medium text-gray-700">Feature nyckel *</label>
                                <input type="text" wire:model.defer="new_feature_key"
                                       ...
                                       placeholder="t.ex. credits.monthly">
                            </div>
                            <div class="lg:col-span-3">
                                <label class="block text-xs font-medium text-gray-700">Gräns (valfri)</label>
                                <input type="text" wire:model.defer="new_feature_limit"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200"
                            ...
                            <div class="lg:col-span-2">
                                <label class="block text-xs font-medium text-gray-700">Status</label>
                                <label class="inline-flex items-center p-2 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                    <input type="checkbox" wire:model="new_feature_enabled"
                                           class="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500 focus:ring-2">
                                    <span class="ml-2 text-xs text-gray-700">Aktiv</span>
                                </label>
                            </div>
                            <div class="lg:col-span-2">
                                <button wire:click="addFeatureRow"
                                        class="w-full inline-flex justify-center items-center px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
