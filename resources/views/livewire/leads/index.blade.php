                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Inga leads hittades</h3>
                                    <p class="text-gray-600">Leads kommer att visas här när besökare interagerar med din sajt.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
