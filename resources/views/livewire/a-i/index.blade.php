<div>
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <!-- Help Modal -->
        <div id="aiHelpModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden opacity-0 transition-opacity duration-300">
            <div class="flex items-center justify-center min-h-screen p-4">
                <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 max-w-2xl w-full max-h-[80vh] overflow-y-auto transform scale-95 transition-transform duration-300" id="aiHelpModalContent">
                    <!-- Header -->
                    <div class="flex items-center justify-between p-6 border-b border-gray-100">
                        ...
                        <button onclick="toggleAiHelpModal()" class="p-2 hover:bg-gray-100 rounded-xl transition-colors duration-200">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <!-- Content Types -->
                        <div class="space-y-4">
                            <h4 class="font-semibold text-gray-900 text-lg">Typer av innehåll du kan skapa:</h4>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h5 class="font-medium text-gray-900">Blogginlägg & artiklar</h5>
                                    <p class="text-sm text-gray-600">Djupgående, SEO-optimerade artiklar som engagerar läsare och bygger expertis inom ditt område.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h5 class="font-medium text-gray-900">Sociala medier-inlägg</h5>
                                    <p class="text-sm text-gray-600">Engagerande innehåll för Facebook, Instagram, LinkedIn och andra plattformar som driver interaktion.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h5 class="font-medium text-gray-900">Produktbeskrivningar</h5>
                                    <p class="text-sm text-gray-600">Säljande beskrivningar för e-handel som framhäver fördelar och driver konverteringar.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h5 class="font-medium text-gray-900">E-postmarknadsföring</h5>
                                    <p class="text-sm text-gray-600">Nyhetsbrev, kampanjmail och automatiserade e-postsekevenser som konverterar läsare till kunder.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Content Status -->
                        <div class="space-y-4">
                            <h4 class="font-semibold text-gray-900 text-lg">Statusar för innehåll:</h4>
                            ...
                            <div class="bg-white rounded-xl p-4 border border-gray-200 space-y-3">
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="inline-flex items-center px-2 py-1 bg-gradient-to-r from-yellow-50 to-amber-50 border-yellow-200/50 border rounded-full">
                                        ...
                                        <span class="text-xs font-medium text-yellow-800 uppercase">DRAFT</span>
                                    </div>
                                    <span class="text-sm text-gray-700"><strong>Utkast:</strong> Innehållet genereras eller redigeras</span>
                                </div>
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="inline-flex items-center px-2 py-1 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200/50 border rounded-full">
                                        ...
                                        <span class="text-xs font-medium text-blue-800 uppercase">PROCESSING</span>
                                    </div>
                                    <span class="text-sm text-gray-700"><strong>Bearbetas:</strong> AI:n arbetar med ditt innehåll</span>
                                </div>
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="inline-flex items-center px-2 py-1 bg-gradient-to-r from-green-50 to-emerald-50 border-green-200/50 border rounded-full">
                                        ...
                                        <span class="text-xs font-medium text-green-800 uppercase">COMPLETED</span>
                                    </div>
                                    <span class="text-sm text-gray-700"><strong>Klart:</strong> Innehållet är genererat och redo för publicering</span>
                                </div>
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="inline-flex items-center px-2 py-1 bg-gradient-to-r from-red-50 to-pink-50 border-red-200/50 border rounded-full">
                                        ...
                                        <span class="text-xs font-medium text-red-800 uppercase">ERROR</span>
                                    </div>
                                    <span class="text-sm text-gray-700"><strong>Fel:</strong> Problem uppstod under genereringen</span>
                                </div>
                            </div>
                        </div>

                        <!-- LinkedIn Quick Generator -->
                        <div class="bg-gradient-to-r from-sky-50 to-blue-50 rounded-xl p-5 border border-sky-200">
                            <h4 class="font-semibold text-sky-900 mb-3 flex items-center">
                                ...
                                LinkedIn snabbgenerator:
                            </h4>
                            <ul class="text-sm text-sky-800 space-y-1">
                                <li>• <strong>Ämnesbaserad:</strong> Ange bara ett ämne så skapar AI:n flera förslag</li>
                                <li>• <strong>Tonalitet:</strong> Välj professionell, personlig eller annan ton</li>
                                <li>• <strong>Snabbpublicering:</strong> Publicera direkt till LinkedIn med en knapptryckning</li>
                                <li>• <strong>Schemaläggning:</strong> Planera inlägg för optimal timing</li>
                                <li>• <strong>Automatisk rensning:</strong> Förslag raderas efter 5 dagar</li>
                            </ul>
                        </div>

                        <!-- Publishing Channels -->
                        <div class="space-y-4">
                            <h4 class="font-semibold text-gray-900 text-lg">Publiceringskanaler:</h4>

                            <div class="bg-white rounded-xl p-4 border border-gray-200">
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                    <div class="flex items-center space-x-2">
                                        <svg class="w-4 h-4 text-orange-600" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <p class="text-xs text-gray-500 mt-3">Färgkodade ikoner visar status: Grön = publicerat, Gul = väntande, Röd = misslyckades</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-5 border border-emerald-200">
                            ...
                            <ol class="text-sm text-emerald-800 space-y-2">
                                <li class="flex items-start space-x-2">
                                    ...
                                    <span>Klicka på <strong>"Nytt innehåll"</strong> för att komma till AI-compositören</span>
                                </li>
                                <li class="flex items-start space-x-2">
                                    ...
                                    <span>Välj innehållsmall (blogginlägg, sociala medier, produktbeskrivning etc.)</span>
                                </li>
                                <li class="flex items-start space-x-2">
                                    ...
                                    <span>Ange ämne, målgrupp och andra detaljer för att få relevant innehåll</span>
                                </li>
                                <li class="flex items-start space-x-2">
                                    ...
                                    <span>Redigera och anpassa innehållet efter dina behov</span>
                                </li>
                                <li class="flex items-start space-x-2">
                                    <span class="w-5 h-5 bg-emerald-600 text-white rounded-full text-xs flex items-center justify-center font-semibold flex-shrink-0 mt-0.5">5</span>
                                    <span>Publicera direkt eller schemalägg för senare</span>
                                </li>
                            </ol>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl p-5 border border-amber-200">
                            <h4 class="font-semibold text-amber-900 mb-2 flex items-center">
                                ...
                                Pro-tips för bäst AI-innehåll:
                            </h4>
                            <ul class="text-sm text-amber-800 space-y-1">
                                <li>• <strong>Var specifik:</strong> Ju mer detaljerad prompt, desto bättre resultat</li>
                                <li>• <strong>Ange målgrupp:</strong> Berätta vem som ska läsa innehållet</li>
                                <li>• <strong>Välj rätt tonalitet:</strong> Professionell, vänlig, auktoritativ etc.</li>
                                <li>• <strong>Inkludera nyckelord:</strong> För bättre SEO-optimering</li>
                                <li>• <strong>Redigera alltid:</strong> AI:n ger en bra grund, men din touch gör det unikt</li>
                            </ul>
                        </div>

                        <!-- Statistics Info -->
                        <div class="bg-white rounded-xl p-4 border border-gray-200">
                            <h5 class="font-medium text-gray-900 mb-2">Förklaring av statistik:</h5>
                            <ul class="text-sm text-gray-600 space-y-1">
                                <li>• <strong>Genereringar:</strong> Antal gånger AI:n har skapat innehåll för dig</li>
                                <li>• <strong>Publiceringar:</strong> Antal gånger innehåll publicerats till olika kanaler</li>
                                <li>• <strong>Mallar:</strong> Fördefinierade strukturer för olika typer av innehåll</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="toggleAiHelpModal()" class="px-4 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors duration-200 text-sm">
                                Stäng
                            </button>
                        </div>
                    </div>
