...
@extends('layouts.guest', ['title' => 'AI Textgenerering – Skapa innehåll på sekunder | WebGrow AI'])

@section('content')
    <main x-data="{ demoOpen: false }">
        <!-- Hero Section -->
        <section class="relative min-h-[600px] overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900">
            <!-- Background Pattern -->
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-white">
                        <div class="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-6">
                            ...
                            <span class="text-sm font-semibold">{{ __('landing.ai_text_hero_badge') }}</span>
                        </div>

                        <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight">
                            {{ __('landing.ai_text_hero_title_1') }}<br>
                            <span class="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                                {{ __('landing.ai_text_hero_title_2') }}
                            </span><br>
                            {{ __('landing.ai_text_hero_title_3') }}
                        </h1>

                        <p class="text-xl text-slate-200 mb-8 leading-relaxed">
                            {{ __('landing.ai_text_hero_subtitle') }}
                        </p>

                        <div class="flex flex-col sm:flex-row gap-4 mb-8">
                            <a href="{{ route('register') }}" class="group inline-flex items-center justify-center px-8 py-4 bg-white text-indigo-900 font-bold rounded-xl shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300">
                                {{ __('landing.ai_text_cta_start') }}
                    ...
                    <div class="relative">
                        <div class="relative bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8 shadow-2xl">
                            <!-- Mockup of AI text generation interface -->
                            <div class="space-y-4">
                                <div class="flex items-center gap-3 pb-4 border-b border-white/10">
                                    ...
                                    <div>
                                        <div class="font-semibold text-white">AI Textgenerering</div>
                                        <div class="text-sm text-slate-400">Genererar innehåll...</div>
                                    </div>
                                </div>

                                <div class="space-y-3">
                                    <div class="bg-white/5 rounded-lg p-4 animate-pulse">
                                    ...
                                    <div class="bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-lg p-4 border border-emerald-500/30">
                                        <div class="flex items-start gap-3">
                                            <svg class="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                                            <div class="text-white text-sm">
                                                <div class="font-semibold mb-1">Text genererad!</div>
                                                <div class="text-slate-300">Din text är redo att publiceras.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Floating elements -->
                        <div class="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl rotate-12 animate-float-1 opacity-80"></div>
                        <div class="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full animate-float-2 opacity-60"></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
                        {{ __('landing.ai_text_features_title') }}
                    </h2>
                    <p class="text-xl text-slate-600 max-w-3xl mx-auto">
                        {{ __('landing.ai_text_features_subtitle') }}
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="group text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-200/50 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-slate-800 mb-2">{{ __('landing.ai_text_feature_1_title') }}</h3>
                        <p class="text-sm text-slate-600">{{ __('landing.ai_text_feature_1_desc') }}</p>
                    </div>
                    ...
                    <div class="group text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200/50 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-slate-800 mb-2">{{ __('landing.ai_text_feature_2_title') }}</h3>
                        <p class="text-sm text-slate-600">{{ __('landing.ai_text_feature_2_desc') }}</p>
                    </div>
                    ...
                    <div class="group text-center p-6 bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl border border-emerald-200/50 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-slate-800 mb-2">{{ __('landing.ai_text_feature_3_title') }}</h3>
                        <p class="text-sm text-slate-600">{{ __('landing.ai_text_feature_3_desc') }}</p>
                    </div>
                    ...
                    <div class="group text-center p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl border border-orange-200/50 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-slate-800 mb-2">{{ __('landing.ai_text_feature_4_title') }}</h3>
                        <p class="text-sm text-slate-600">{{ __('landing.ai_text_feature_4_desc') }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-gradient-to-br from-slate-50 to-indigo-50">
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
                        {{ __('landing.ai_text_benefits_title') }}
                    </h2>
                </div>

                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div class="text-5xl font-bold text-indigo-600 mb-2">80%</div>
                        <p class="text-slate-700 font-medium">{{ __('landing.ai_text_benefit_1') }}</p>
                    </div>
                    <div class="text-center">
                        <div class="text-5xl font-bold text-purple-600 mb-2">100%</div>
                        <p class="text-slate-700 font-medium">{{ __('landing.ai_text_benefit_2') }}</p>
                    </div>
                    <div class="text-center">
                        <div class="text-5xl font-bold text-emerald-600 mb-2">SEO</div>
                        <p class="text-slate-700 font-medium">{{ __('landing.ai_text_benefit_3') }}</p>
                    </div>
                    <div class="text-center">
                        <div class="text-5xl font-bold text-pink-600 mb-2">✓</div>
                        <p class="text-slate-700 font-medium">{{ __('landing.ai_text_benefit_4') }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-white">
            <div class="max-w-5xl mx-auto px-4">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="relative">
                        <div class="text-center">
                            <div class="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">1</div>
                            <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('landing.ai_text_how_step_1_title') }}</h3>
                            <p class="text-slate-600">{{ __('landing.ai_text_how_step_1_desc') }}</p>
                        </div>
                        <svg class="hidden md:block absolute top-8 -right-4 w-8 h-8 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                        </svg>
                    </div>
                    ...
                    <div class="relative">
                        <div class="text-center">
                            <div class="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">2</div>
                            <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('landing.ai_text_how_step_2_title') }}</h3>
                            <p class="text-slate-600">{{ __('landing.ai_text_how_step_2_desc') }}</p>
                        </div>
                        <svg class="hidden md:block absolute top-8 -right-4 w-8 h-8 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                        </svg>
                    ...
                    <div class="text-center">
                        <div class="w-16 h-16 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">3</div>
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('landing.ai_text_how_step_3_title') }}</h3>
                        <p class="text-slate-600">{{ __('landing.ai_text_how_step_3_desc') }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 relative overflow-hidden">
            ...
            <div class="relative max-w-4xl mx-auto px-4 text-center">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">
                    {{ __('landing.ai_text_cta_final') }}
                </h2>
                <p class="text-xl text-slate-300 mb-12">
                    {{ __('landing.ai_text_cta_final_subtitle') }}
                </p>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                        ...
                        <form action="{{ route('demo.request') }}" method="POST" class="space-y-4">
                            ...
                            <div class="flex gap-3 pt-4">
                                <button type="button" @click="demoOpen = false" class="flex-1 px-6 py-3 border border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-colors">
                                    Avbryt
                                </button>
                                <button type="submit" class="flex-1 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-colors">
                                    Skicka förfrågan
                                </button>
                            </div>
                        </form>
